...
<body>
  ...
  <aside class="sidebar">
      <nav class="sidebar__navigation">
        ...
        <br>
        <a href="reviews.php" class="sidebar__link">Отзывы клиентов</a>
        <br>
