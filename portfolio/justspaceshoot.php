    ...
    <article class="about">
      ...
      <section class="about__text">
        ...
        в скорости у других движков.
         Параллельно работе разработчика, дизайнер подготовил звуковые эффекты, иконку для приложения и скриншоты
        для App Store.
         Следующим этапом оставалось провести оптимизацию ключевых слов, используя собственные наработанные решения.
         Все исходники нашего проекта находятся в свободном доступе на github, что позволяет пользоваться нашими готовыми решениями.
      </section>
    </article>
  </main>
  <?php
